...
module.exports = class Pet {
  ...
  save() {
    return db.execute(
      'INSERT INTO rent (pet_name, refugee, city, available, price, imageUrl, pet_description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
      [this.name, this.refugee, this.city, this.available, this.price, this.image_url, this.available_date, this.description]
    );
  }
